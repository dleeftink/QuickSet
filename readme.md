...
#### `.add(uint[, value])`
Inserts a single integer into the set if within range (based on the lower [`clip`](#clip-0--228) and upper [`span`](#span-0--228) bound), with an optional weight/value (limited to [`high`](#high-0--232)). 
